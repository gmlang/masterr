---
layout: post
title: "Mortgage Amortization Schedule Calculator in R"
date: 2018-11-20
comments: true
categories: r
keywords: "R, financial calculator, mortgage calculator, amortization schedule, amortization schedule calculator"
published: true
share: true
ads: true
---

This is the first article of a series on how environments work in R. We'll introduce a problem and present a solution without using environments
