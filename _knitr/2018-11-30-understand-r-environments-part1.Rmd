...
This concludes the first article of the series. If you're not confused yet, click here for the [second article], which provides a high level summary of this first article and shows how the `<<-` operator works. 
