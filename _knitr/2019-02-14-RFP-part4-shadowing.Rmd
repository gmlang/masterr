...
library(DiagrammeR)
mermaid("graph LR; x --> val1((3)); 
        style x fill:#C0C0C0, stroke:#000000
        style val1 fill:#FFFFFF, stroke:#000000")
```
...
```{r, echo = F, fig.align='center'}
mermaid("graph LR; x -.-> val1((3)); x ==> val2((32));
        style x fill:#C0C0C0, stroke:#000000
        style val1 fill:#FFFFFF, stroke:#000000
        style val2 fill:#FFFFFF, stroke:#000000
        ")
```
...
```{r, echo = F, fig.align='center'}
mermaid("graph LR; id1(x) --> val1((3)); id2(x) --> val2((32));
        style id1 fill:#C0C0C0, stroke:#000000
        style id2 fill:#C0C0C0, stroke:#000000
        style val1 fill:#FFFFFF, stroke:#000000
        style val2 fill:#FFFFFF, stroke:#000000
        ")
```
